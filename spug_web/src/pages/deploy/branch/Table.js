    ...
    return (
      <React.Fragment>
        <Table
          ...
          <Table.Column title="冲刺" dataIndex="zone"/>
          <Table.Column title="分支名" dataIndex="name" sorter={(a, b) => a.name.localeCompare(b.name)}/>
          <Table.Column title="应用" dataIndex="hostname" sorter={(a, b) => a.name.localeCompare(b.name)}/>
